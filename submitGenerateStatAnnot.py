...
for sim in glob.glob(currentPath + "/simulated_data/sim*"):
	...
	print simFilName;
	if os.path.exists(currentPath + "/simulated_data/" + "SummaryStatistics/" + simFilName + ".sumstats"):
		continue;
	...
	script =  "python " + currentPath + "/generateSimStatAnnot.py -f " + simFilName + " -p " + currentPath +  "/simulated_data/";
	print script;
