...
for simFiles in glob.glob(currentPath + "/annots/allciseQTL/*"):
        simFileName = simFiles.replace(currentPath + "/annots/allciseQTL/", "");
        annotFileName=simFiles + "/" + "allciseQTL.1.annot"

        if (os.path.exists(simFiles + "/allciseQTL.1.l2.ldscore.gz")):
                continue;
        else :
                print simFiles;
...
for simFiles in glob.glob(currentPath + "/annots/Set_CAVIAR/*"):
        simFileName = simFiles.replace(currentPath + "/annots/Set_CAVIAR/", "");
        annotFileName=simFiles + "/" + "Set_CAVIAR.1.annot"

        if (os.path.exists(simFiles + "/Set_CAVIAR.1.l2.ldscore.gz")):
                continue;
        else :
                print simFiles;
...
for simFiles in glob.glob(currentPath + "/annots/MaxPPC_CAVIAR/*"):
        ...
        if (os.path.exists(simFiles + "/MaxPPC_CAVIAR.1.l2.ldscore.gz")):
                continue;
        else :
                print simFiles;
